    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-bottom: 3rem;">
        ...
        <div style="background: white; padding: 1.5rem; border-radius: 16px; display: flex; align-items: center; gap: 1.25rem; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); border: 1px solid #f1f5f9;">
            ...
            <div>
                ...
                <h3 style="font-size: 1.75rem; font-weight: 800; color: #1e293b; margin: 0.2rem 0 0 0;">{{ $pendingRegistrationsCount }}</h3>
            </div>
        </div>
        ...
        <div style="background: white; padding: 1.5rem; border-radius: 16px; display: flex; align-items: center; gap: 1.25rem; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); border: 1px solid #f1f5f9;">
            ...
            <div>
                ...
                <h3 style="font-size: 1.75rem; font-weight: 800; color: #1e293b; margin: 0.2rem 0 0 0;">{{ $latestEvents->count() }}</h3>
            </div>
        </div>
    </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.5rem;">
                @forelse($myClubs as $club)
                    <div style="background: white; border-radius: 18px; padding: 1.25rem; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); border: 1px solid #f1f5f9; transition: transform 0.2s, box-shadow 0.2s;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 12px 20px -5px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 6px -1px rgba(0,0,0,0.05)'">
                        ...
                        <p style="font-size: 0.9rem; color: #64748b; line-height: 1.5; margin-bottom: 1.25rem; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                            {{ $club->description }}
                        </p>
                ...
                @empty
                    <div style="grid-column: span 2; background: #f8fafc; border: 1.5px dashed #e2e8f0; border-radius: 20px; padding: 3rem; text-align: center; color: #94a3b8;">
        ...
        <div>
            ...
            <div style="display: grid; gap: 1rem;">
                @forelse($latestEvents as $event)
                    <div style="background: white; border-radius: 16px; padding: 1.25rem; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); border: 1px solid #f1f5f9;">
            ...
            <!-- DISCOVER CLUBS BOX -->
            <div style="margin-top: 2rem; background: #eff6ff; border-radius: 18px; padding: 1.5rem; border: 1px solid #dbeafe;">
                <h4 style="color: #1e40af; font-weight: 800; margin-bottom: 1rem;">Gợi ý câu lạc bộ mới</h4>
                <div style="display: grid; gap: 0.75rem;">
                    @foreach($latestClubs as $c)
                        <a href="{{ route('member.clubs.index') }}" style="text-decoration: none; background: white; padding: 0.75rem; border-radius: 12px; display: flex; align-items: center; gap: 0.75rem; border: 1px solid #dbeafe;">
                            <div style="width: 40px; height: 40px; border-radius: 8px; background: #eff6ff; display: flex; align-items: center; justify-content: center; color: #3b82f6; font-size: 1.1rem;">
                                <i class="fas fa-layer-group"></i>
                            </div>
                            <span style="font-weight: 700; color: #334155; font-size: 0.9rem;">{{ $c->name }}</span>
                        </a>
                    @endforeach
                </div>
            </div>
